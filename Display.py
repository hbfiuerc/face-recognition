...
save_model = tf.keras.models.load_model("my_model.keras")
...
for (x, y, w, h) in fa:
    ...
    if final == 0:
        cv2.putText(image, "Chi Pu",(x+10,y+h+ 30), fontface, 1, (0,255,0),2)
    if final == 1:
        cv2.putText(image, "Chi Dan",(x+10,y+h+ 30), fontface, 1, (0,255,0),2)
    if final == 2:
        cv2.putText(image, "Quang Hai",(x+10,y+h+ 30), fontface, 1, (0,255,0),2)
    if final == 3:
        cv2.putText(image, "Son Tung",(x+10,y+h+ 30), fontface, 1, (0,255,0),2)
    if final == 4:
